    ...
    <%
        ...
        try {
            ...
            if(request.getParameter("session.n2ESIII") == ""){
                ...
                notasProva[6][1] = Double.parseDouble(request.getParameter("session.n2POO"));
            }
            ...
            notasProva[8][0] = 0;
                ...
                notasProva[8][0] = Double.parseDouble(request.getParameter("session.n1ALP"));
            }     
            if(request.getParameter("session.n2ALP") == ""){
                notasProva[8][1] = 0;
            }else{
                notasProva[8][1] = Double.parseDouble(request.getParameter("session.n2ALP"));
            }
    ...
    <body>
        ...
        <form method="post">
            <table border="2" cellpadding="2">
                ...
                <tr>
                    <td>ES III</td>
                    <td><input type="number" value="<%= session.getAttribute("session.n1ES III") %>" name="session.n1ES III"></td>
                    <td><input type="number" value="<%= session.getAttribute("session.n2ES III") %>" name="session.n2ES III"></td>
                </tr>
                <tr>
                    <td>LPIV</td>
                    <td><input type="number" value="<%= session.getAttribute("session.n1LPIV") %>" name="session.n1POO"></td>
                    <td><input type="number" value="<%= session.getAttribute("session.n2LPIV") %>" name="session.n2POO"></td>
                </tr>
                <tr>
                    <td>ALP</td>
                ...
                <%}else{%>
                <div color="red"><p>Sem permissão, por favor fazer o login novamente</p></div>
                <% session.invalidate(); %>
                <% } %>
    </body>
</html>
